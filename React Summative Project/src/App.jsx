...
import MyContacts from './Additions/Contact'
...
export default function App(){
  ...
  return(
    ...
    <div className='grid gap-6 px-6 py-8 md:grid-cols-2'>
      ...
      <div className='rounded-3xl border-4 border-white-200 bg-sky-50/80 p-6 shadow-sm'>
    
    <ProjectForm onSubmission={Submission} />

      </div>

    <div className='overflow-auto rounded-3xl border-4 border-white-200 bg-white/75 p-6 shadow-sm backdrop-blur-sm'>
